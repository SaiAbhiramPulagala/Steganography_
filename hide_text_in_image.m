% This demo takes a text string from the user and hides it in the bits of a gray scale image.
% By default, the bit plane is the lowest bit plane (#1) but you can choose another bit plane if you want,
% though the alteration will be more noticeable the higher the bit plane you use.
